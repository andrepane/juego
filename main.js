...
refs.helpToggle.addEventListener('click', () => { if (orderConfigurator.getPolicy().alwaysShowHelp) return; const expanded = refs.helpToggle.getAttribute('aria-expanded') === 'true'; refs.helpToggle.setAttribute('aria-expanded', String(!expanded)); refs.helper.classList.toggle('hidden', expanded); });
